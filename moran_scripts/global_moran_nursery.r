...
# save as RDS
saveRDS(result, "~/moran_files/4nurs/global_results/mglobal_results_1-120.rds")
...
# save as RDS
saveRDS(result, "~/moran_files/4nurs/global_results/mglobal_results_121-240.rds")
