##              LOCAL MORANS EXPERIMENT 1                ##
library(pgirmess)
library(parallel)
library(gtools)
setwd('~/mantel_files/exp1/runs/') # original mimicry
...
# save as RDS
saveRDS(result, "~/moran_files/exp1/local/local_exp1_1-120.rds")
...
# save as RDS
saveRDS(result, "~/moran_files/exp1/local/local_exp1_121-240.rds")
...
# save as RDS
saveRDS(result, "~/moran_files/exp1/local/local_exp1_241-360.rds")
...
# save as RDS
saveRDS(result, "~/moran_files/exp1/local/local_exp1_361-480.rds")
...
# save as RDS
saveRDS(result, "~/moran_files/exp1/local/local_exp1_481-500.rds")
