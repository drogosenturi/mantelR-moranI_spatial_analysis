...
result <- mclapply(1:60, global_moran, mc.preschedule = FALSE, mc.cores = 30)
message("local test finish 1: ", Sys.time())

# save as RDS
saveRDS(result, "~/moran_files/exp3/global/global_exp3_1-60.rds")
