##              Mantel local for no mimicry, 4 nurseries            ##
...
species_dists <- readRDS("~/mantel_files/8nurs_result/sp_dist_eight_1-30.rds")
...
# save as rds
saveRDS(v_result, "~/mantel_files/8nurs_result/local_results/local_1-15.rds")
Sys.sleep(10)
...
# save as rds
saveRDS(v_result, "~/mantel_files/8nurs_result/local_results/local_16-30.rds")
