...
species_dists <- readRDS("~/mantel_files/cntrl_8nurs_result/sp_dist_cntrl_eight_1-10.rds")
...
# save as rds
saveRDS(v_result, "~/mantel_files/cntrl_8nurs_result/local_results/local_1-10.rds")
