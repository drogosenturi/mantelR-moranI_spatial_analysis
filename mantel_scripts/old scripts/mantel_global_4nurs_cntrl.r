...
species_dists <- readRDS("~/mantel_files/cntrl_result/sp_dist_control_1-10.rds")

# apply function
result <- mclapply(1:10, mantel_global, mc.cores = 10)

# save result
saveRDS(result, "~/mantel_files/cntrl_result/global_results/global_1-10.rds")
